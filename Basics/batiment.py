...
Immeuble1 = immeuble("aysha", "mbirdiam", 2, 7)
Immeuble2 = immeuble("Sabaly", "Thies", 3, 9)
Immeuble3 = immeuble("Penda", "Pouyenne", 4, 11)
Immeuble4 = immeuble("Diadel", "Dakar", 5, 12)

Supermarche = supermarche("Penda&Co", "Km50", 10, 13)
Supermarche1 = supermarche("Moustapha&Co", "keur_Issa", 15, 20)

Banque = banque("Banque_Islamique", "St_Louis", 6, 25)
